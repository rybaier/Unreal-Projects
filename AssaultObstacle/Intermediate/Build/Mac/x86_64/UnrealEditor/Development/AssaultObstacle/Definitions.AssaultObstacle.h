...
#define UE_PROJECT_NAME AssaultObstacle
#define UE_TARGET_NAME AssaultObstacleEditor
#define UE_MODULE_NAME "AssaultObstacle"
...
#define ASSAULTOBSTACLE_API DLLEXPORT
